...
SOURCES = cone.c cylinder.c main.c essai.c init_env.c object.c plan.c sphere.c vector.c
...
$(NAME): $(OBJECTS)
	...
	$(CC) $(CFLAGS) $(SRCS) $(INCS)
	mkdir objs
	mv init_env.o main.o essai.o sphere.o plan.o cylinder.o cone.o vector.o object.o $(DIR_OBJ)
