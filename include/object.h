...
/*   Updated: 2017/10/13 19:51:35 by fgallois         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_obj				*add_obj(t_obj *obj, int obj_type, t_mater *mater, \
		void *type);
...
t_hit_point			hit_positiv(t_cone *cone, t_ray r, float expr, float expr2);
...
t_hit_point			resolution_sphere(t_sphere *sp, t_ray r, float delta, \
		float b);
